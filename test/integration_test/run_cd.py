...
def main():
    ...
    rm_cwd_test = [
        ...
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd - {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd .. {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd . {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd ././ {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd ./.. {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd ../../../../../ {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=nosuchdir \n cd - {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=nosuchdir \n cd - {STATUS_PWD_DISPLAY} cd - {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=nosuchdir \n cd - {STATUS_PWD_DISPLAY} cd ../.. {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=nosuchdir \n cd .. {STATUS_PWD_DISPLAY} cd - {STATUS_PWD_DISPLAY}",
        f"{REGISTER_PATH} {RM_CWD_AND_CD_PRE} export OLDPWD=$HOME \n cd - {STATUS_PWD_DISPLAY} cd / {STATUS_PWD_DISPLAY}",
